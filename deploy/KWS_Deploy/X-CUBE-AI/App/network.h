...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_float_opset13_cubeai"
...
#define AI_NETWORK_IN_1_HEIGHT      (62)
#define AI_NETWORK_IN_1_WIDTH       (13)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (806)
#define AI_NETWORK_IN_1_SIZE_BYTES  (3224)
